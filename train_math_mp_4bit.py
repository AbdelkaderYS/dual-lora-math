...
OUTPUT_DIR = "/mnt/scratch/djagbapr/lora_outputs/dual_lora_math_mp_4bit"
LOG_DIR = "/mnt/scratch/djagbapr/lora_outputs/logs_4bit"
...
model = apply_dual_lora_4bit(model, config)
...
save_cfg = {
    ...
    "data": "math_mp", "quantization": "4bit_nf4",
}
